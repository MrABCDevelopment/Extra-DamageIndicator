    ...
    public HologramsHandler(EDIMain plugin) {
        ...
        try {
            ...
            if (Settings.supportedPlugins.get("HolographicDisplays") && Bukkit.getPluginManager().getPlugin("HolographicDisplays") != null) {
                hapi = Class.forName("me.mrabcdevelopment.github.edi.holograms.HolographicDisplaysHolo").asSubclass(IHologram.class);
            } else if (Settings.supportedPlugins.get("DecentHolograms") && Bukkit.getPluginManager().getPlugin("DecentHolograms") != null) {
                hapi = Class.forName("me.mrabcdevelopment.github.edi.holograms.DecentHologramsHolo").asSubclass(IHologram.class);
            } else {
                hapi = Class.forName("me.mrabcdevelopment.github.edi.holograms.DefaultHolo").asSubclass(IHologram.class);
            }
