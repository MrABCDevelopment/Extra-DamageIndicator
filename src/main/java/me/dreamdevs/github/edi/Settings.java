...
public class Settings {
    ...
    public Settings(EDIMain plugin) {
        plugin.reloadConfig();
        damageMessageHolo = ColourUtil.colorize(plugin.getConfig().getString("Damage-Message"));
        regenerationMessageHolo = ColourUtil.colorize(plugin.getConfig().getString("Regeneration-Message"));
